...
import { ArrowRight, Sparkles, Gavel, Quote, Info, RotateCcw } from 'lucide-react';
...
export default function ClientHome({ professions, startAtMenu }: ClientHomeProps) {
    ...
    return (
      <main className="min-h-screen bg-slate-50 p-10 animate-in fade-in duration-700">
        <header className="mb-12 text-center relative max-w-7xl mx-auto">
          ...
          {/* Mobile-only Replay Button (Centered below title) */}
          <button 
            onClick={() => setStep(0)}
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500 key={step}">
